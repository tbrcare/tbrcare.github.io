...
<title>행복한노인복지센터 전단지 > 갤러리 | 행복한노인복지센터</title>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
           <li><a href="board1922.php?bo_table=gallery&amp;page=" class="btn_b01 btn"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li>
                ...
                <ul class="bo_v_nb">
                        <li class="btn_next"><span class="nb_tit"><i class="fa fa-caret-down" aria-hidden="true"></i> 다음글</span><a href="board3561.html?bo_table=gallery&amp;wr_id=2">행복한노인복지센터 실내</a>  <span class="nb_date">19.09.29</span></li>        </ul>
                    </div>
    <!-- } 게시물 상단 버튼 끝 -->
