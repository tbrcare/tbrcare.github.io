...
<title>온라인상담 글쓰기 | 행복한노인복지센터</title>
...
<section id="bo_w">
    ...
    <!-- 게시물 작성/수정 시작 { -->
    <form name="fwrite" id="fwrite" action="http://daycare119.com/bbs/write_update.php" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:100%">
